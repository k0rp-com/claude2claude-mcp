...
function renderInstall(r: BootstrapResult): string {
  ...
  return [
    ...
    '    /peer-name <a-short-name-for-this-machine>',
    '    /peer-id              # show your fingerprint, give it to the other machine',
    '',
    '  To pair two machines:',
    '    On machine A:  /peer-pair <B-fingerprint>',
    '    A will print a 4-digit code. Tell it to user-of-B.',
    '    On machine B:  /peer-confirm <code>',
    '    Done — they can now /peer-send <name> ...',
    '',
    bar,
    '  SECURITY:',
